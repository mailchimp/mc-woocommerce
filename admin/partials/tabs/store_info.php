...
<fieldset class="">  
	...
	<div class="box box-half" >
		...
		<input required type="text" id="<?php echo $this->plugin_name; ?>-store-name-label" name="<?php echo $this->plugin_name; ?>[store_name]" value="<?php echo esc_html((isset( $options['store_name'] ) ? $options['store_name'] : get_option( 'blogname' ))); ?>" />
	</div>
	...
	<div class="box box-half" >
		...
		<input required type="email" id="<?php echo $this->plugin_name; ?>-admin-email-label" name="<?php echo $this->plugin_name; ?>[admin_email]" value="<?php echo esc_html((isset( $options['admin_email'] ) ? $options['admin_email'] : get_option( 'admin_email' ))); ?>" />
	</div>
	...
	<div class="box box-half" >
		...
		<input required type="text" id="<?php echo $this->plugin_name; ?>-store-address-label" name="<?php echo $this->plugin_name; ?>[store_street]" value="<?php echo esc_html((isset( $options['store_street'] ) ? $options['store_street'] : WC()->countries->get_base_address())); ?>" />
	</div>
	...
	<div class="box box-half" >
		...
		<input required type="text" id="<?php echo $this->plugin_name; ?>-store-city-label" name="<?php echo $this->plugin_name; ?>[store_city]" value="<?php echo esc_html((isset( $options['store_city'] ) ? $options['store_city'] : WC()->countries->get_base_city())); ?>" />
	</div>
	...
	<div class="box box-half" >
		...
		<input required type="text" id="<?php echo $this->plugin_name; ?>-store-state-label" name="<?php echo $this->plugin_name; ?>[store_state]" value="<?php echo esc_html((isset( $options['store_state'] ) ? $options['store_state'] : WC()->countries->get_base_state())); ?>" />
	</div>
	...
	<div class="box box-half" >
		...
		<input required type="text" id="<?php echo $this->plugin_name; ?>-store-postal-code-label" name="<?php echo $this->plugin_name; ?>[store_postal_code]" value="<?php echo esc_html((isset( $options['store_postal_code'] ) ? $options['store_postal_code'] : WC()->countries->get_base_postcode())); ?>" />
	</div>
	...
	<div class="box box-half" >
		...
		<input required type="text" id="<?php echo $this->plugin_name; ?>-store-phone-label" name="<?php echo $this->plugin_name; ?>[store_phone]" value="<?php echo esc_html((isset( $options['store_phone'] ) ? $options['store_phone'] : '')); ?>" />
	</div>

	<div class="box fieldset-header" >
		<h3 style="padding-top: 1em;"><?php echo __( 'Locale Settings', 'mailchimp-for-woocommerce' ); ?></h3>   
	</div>
	...
	<div class="box box-half" >
		...
		<label for="<?php echo $this->plugin_name; ?>-store-locale-label">
			...
			<span class="required-field-mark">*</span>
			<p><?php echo __( 'Please apply your locale settings. If you\'re unsure about these, use the defaults.', 'mailchimp-for-woocommerce' ); ?></p>
		</label>
	...
	<div class="box box-half" >
		<div class="mailchimp-select-wrapper">
			<select name="<?php echo $this->plugin_name; ?>[store_locale]" required>
				<option disabled selected value="<?php echo __( '', 'mailchimp-for-woocommerce' ); ?>"><?php echo __( "Select store's locale", 'mailchimp-for-woocommerce' ); ?></option>
				<?php
	...
	if ( current_user_can( 'manage_options' ) ) :
		?>
		<div class="box fieldset-header" >
			<h3 style="padding-top: 1em;"><?php echo __( 'Permission Settings', 'mailchimp-for-woocommerce' ); ?></h3>   
		</div>
		<div class="optional-settings-content">
			...
			<div class="box box-half margin-large">
				...
				<label class="radio-label">
					<input type="radio" name="<?php echo $this->plugin_name; ?>[mailchimp_permission_cap]" value="manage_options"
														 <?php
															if ( $checkbox_default_settings === 'manage_options' ) {
																echo ' checked="checked" ';}
															?>
					><?php esc_html_e( 'Administrators Only', 'mailchimp-for-woocommerce' ); ?><br>
				</label>
				<label class="radio-label">
					<input type="radio" name="<?php echo $this->plugin_name; ?>[mailchimp_permission_cap]" value="manage_woocommerce"
														 <?php
															if ( $checkbox_default_settings === 'manage_woocommerce' ) {
																echo ' checked="checked" ';}
															?>
					><?php esc_html_e( 'Shop Managers and Administrators', 'mailchimp-for-woocommerce' ); ?><br/>
				</label>
			</div>
		</div>
	<?php endif; ?>
