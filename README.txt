...
== Changelog ==
= 4.3 =
- Order HPOS function for pagination
- start syncing customers via HPOS
- Change sync order: customers > products > coupons > orders — and make sync actions more atomic
- Use direct WP DB SELECT / INSERT for sync options to circumvent object caching
- Remove the bundled version of Action Scheduler
