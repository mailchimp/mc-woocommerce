...
<div class="mc-woocommerce-settings">
    <?php if($show_wizard): ?>
        <div class="mc-woocommerce-settings-header-wrapper wiz-header">
            <div class="mc-woocommerce-settings-header">
                <svg width="93" height="93" viewBox="0 0 46 49" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="nav-wizard-wrapper">
            ...
            <?php if ($has_valid_api_key) : ?>    
                <div class="wizard-tab <?php echo $active_tab == 'store_info' ? 'wizard-tab-active' : ''; ?>">
                    ...
                    <div class="wizard-tab-tooltip wizard-tab-tooltip-store-info "><?= esc_html_e('Store', 'mailchimp-for-woocommerce');?>
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="14.498" width="20" height="20" transform="rotate(45 14.498 0)" fill="white"/>
                        </svg>
                    </div>
            ...
            <?php if ($handler->hasValidStoreInfo() && $show_newsletter_settings && $this->getData('validation.store_info', false)) : ?>  
                <div class="wizard-tab <?php echo $active_tab == 'newsletter_settings' ? 'wizard-tab-active' : ''; ?>">
                    ...
                    <div class="wizard-tab-tooltip wizard-tab-tooltip-store-info "><?= esc_html_e('Audience', 'mailchimp-for-woocommerce');?>
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="14.498" width="20" height="20" transform="rotate(45 14.498 0)" fill="white"/>
                        </svg>
                    </div>
    ...
    <?php if ($active_tab != 'sync' && $active_tab != 'api_key'): ?>
