...
<fieldset>
		...
		<fieldset>
			<p id="mc-comm-wrapper">
				<label class="el-switch el-checkbox-green">
					<input id="tower_box_switch" type="checkbox" name="switch" 
					<?php
					if ( $tower_enabled === '1' ) {
						echo ' checked="checked" ';}
					?>
					 value="1">
					<span><?php echo __( 'Enable support', 'mailchimp-for-woocommerce' ); ?></span>
					<br/>
	...
	<div class="box ">
		...
		<fieldset>    
			<p id="mc-comm-wrapper">
				<label class="el-switch el-checkbox-green">
					<input id="comm_box_switch" type="checkbox" name="switch" 
					<?php
					if ( $comm_enabled === '1' ) {
						echo ' checked="checked" ';}
					?>
					 value="1">
					<span><?php echo __( 'Opt-in to our newsletter', 'mailchimp-for-woocommerce' ); ?></span>
					<br/>
